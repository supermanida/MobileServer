...
//
//*************************************************************************************************
public class HubOrganizationSynchronizer extends Thread
{
	//*********************************************************************************************
	//
	//*********************************************************************************************
	...
	//
	//*********************************************************************************************
	public HubOrganizationSynchronizer(HubProcessor hubProcessor, String ip, int port, String name)
	{
	...
	public void run()
	{
		while ( true )
		{
			try
			{
				...
				while (true)
				{
					...
					try
					{
						...
						{
							//synchronized(hubProcessor.dataBean.organizationClientDebugStr)
							//{
								//hubProcessor.dataBean.organizationClientDebugStr.append(processStr);
							//}
							
							//hubProcessor.log("HubOrganizationSynchronizer", processStr);
					...
					{
						ee.printStackTrace();
						//hubProcessor.exception("HubOrganizationSynchronizer", ee);
					}
				}
			}
			catch(Exception e)
			{
				e.printStackTrace();
				//hubProcessor.exception("HubOrganizationSynchronizer", e);
			}
			finally
			{
