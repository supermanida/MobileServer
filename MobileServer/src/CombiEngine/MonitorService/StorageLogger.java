...
public class StorageLogger extends Thread
{
	...
	public StorageLogger(InputStreamReader ir, BufferedReader br, PrintWriter pw, Socket s, ResetStatus logger)
	{
		this.ir = ir;
		this.br = br;
		this.pw = pw;
	...
	public void run()
	{
		try
		{
			while ( true )
			{
				pw.println(logger.getStorageStatus() + "\f");
