...
public class CpuLogger extends Thread
{
	...
	public CpuLogger(InputStreamReader ir, BufferedReader br, PrintWriter pw, Socket s, ResetStatus logger)
	{
		this.ir = ir;
		this.br = br;
		this.pw = pw;
	...
	public void run()
	{
		try
		{
			while ( true )
			{
				pw.println(logger.getCpuStatus() + "\f");
