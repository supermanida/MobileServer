...
public class ProcessorLogger extends Thread
{
	...
	public ProcessorLogger(InputStreamReader ir, BufferedReader br, PrintWriter pw, Socket s, ResetStatus logger)
	{
		this.ir = ir;
		this.br = br;
		this.pw = pw;
	...
	public void run()
	{
		try
		{
			while ( true )
			{
				pw.println(logger.getProcessorStatus() + "\f");
